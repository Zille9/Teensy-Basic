...
extern void Update_tia_sound (unsigned int addr, unsigned char val);
extern void Tia_process_2 (register unsigned short *buffer,
                    register unsigned int n);
extern void Tia_process (register unsigned char *buffer,
                    register unsigned int n);
#endif 
